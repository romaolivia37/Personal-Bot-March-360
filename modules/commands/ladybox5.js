...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
	...
	if (event.body.indexOf("Lady 5")==0 || event.body.indexOf("Ledy 5")==0 || event.body.indexOf("ledy 5")==0 || event.body.indexOf("lady 5")==0) {
		var msg = {
				body: "-Facebook Name :- Eva____,*:/3:) Name:- Arobi হাত মারা মাগি 🥵 আইডির বিনিময়ে হাত মারে✌🏻 ★5 নাম্বার দারোয়ান  মাগির পুত সাহেল কে দেখতে চাইলে লিখুন :- সাগেল ★ ★ ★Support Email:- mr.anonymous404@yahoo.com",
