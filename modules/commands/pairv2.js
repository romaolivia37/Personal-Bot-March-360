...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
        ...
        if(money < 500) api.sendMessage("You need 500 USD for 1 pairing, please use daily to get money work to received money or ask for admin bot!\nðŸ¤‘Theres something new to eatðŸ¤‘",event.threadID,event.messageID)
        else {
        ...
        var gender = sex == 2 ? "MaleðŸ§‘" : sex == 1 ? "FemaleðŸ‘©â€ðŸ¦°" : "TraÌ‚Ì€n ÄuÌ›Ìc Bo";
